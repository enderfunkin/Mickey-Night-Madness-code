...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Really Madness Night",	"Play on a Friday Night.",						'friday_night_play',	 true],
		["Suicide its not Good",		"Beat Week Mickey on hard with no Misses.",				'week1_nomiss',			false],
		["Stop Driping",				"Beat Week Drip on Hard with no Misses.",				'week2_nomiss',			false],
		["Memes",			"Beat Week Memes on Hard with no Misses.",				'week3_nomiss',			false],
    ];
